...
from odoo.addons.aos_whatsapp_base_aretx.models.whatsapp_history import image_type, video_type, audio_type, document_type
...
class Components(models.Model):
    ...
    button_text = fields.Char(string='Button Text', required=True, help="Text displayed on the button")

    coupon_text = fields.Char(string='Coupon Code', help="Coupon code for copy_code button type")
