...
class WATemplate(models.Model):
    ...
    def init(self):
        video_path = tools.misc.file_path('aos_whatsapp_base_aretx/static/src/video/wa-demo-video.mp4')
        ...
        pdf_path = tools.misc.file_path('aos_whatsapp_base_aretx/static/src/pdf/TestPDFfile.pdf')
        ...
        pdf_path = tools.misc.file_path('aos_whatsapp_base_aretx/static/src/image/whatsapp_default_set.png')
