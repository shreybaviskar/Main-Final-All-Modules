...
class ResConfigSettings(models.TransientModel):
    ...
    md_sale = fields.Boolean(
        ...
        config_parameter='tus_meta_whatsapp_base.md_sale'
    )
    ...
    module_tus_meta_whatsapp_base = fields.Boolean("Tus Whatsapp Invoice")
    ...
    module_tus_meta_whatsapp_base_in_discuss = fields.Boolean("Tus Whatsapp Invoice In Discuss")
    ...
    @api.onchange('module_tus_meta_whatsapp_base_in_discuss')
    def on_module_tus_meta_whatsapp_base_in_discuss(self):
        ModuleSudo = self.env['ir.module.module'].sudo()
        modules = ModuleSudo.search(
            [('name', '=', 'module_tus_meta_whatsapp_base_in_discuss'.replace("module_", ''))])
        if not modules and self.module_tus_meta_whatsapp_base_in_discuss:
            return {
                'warning': {
                    'title': _('Warning!'),
    ...
    @api.onchange('module_tus_meta_whatsapp_base')
    def on_module_tus_meta_whatsapp_base(self):
        ModuleSudo = self.env['ir.module.module'].sudo()
        modules = ModuleSudo.search(
            [('name', '=', 'module_tus_meta_whatsapp_base'.replace("module_", ''))])
        if not modules and self.module_tus_meta_whatsapp_base:
            return {
                'warning': {
                    'title': _('Warning!'),
